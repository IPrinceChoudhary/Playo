...
const EmailVerificationModal = ({
  ...
  return (
    <div className="fixed -inset-x-80 -inset-y-3 bg-glacier-1300 flex items-center justify-center z-50">
      ...
      <div className="absolute flex items-center bottom-8 right-8 bg-glacier-500 p-3 text-fresh-500 text-2xl font-bold rounded-md">
